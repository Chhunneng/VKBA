...
class CustomerForm(forms.ModelForm):
    ...
    # <Add "phone_number" field in class Meta
    class Meta:
        model = User
        fields = ["first_name", "last_name", "phone_number", "email", "note", "is_active"]
        labels = {
            ...
            "phone_number": pgettext_lazy("Customer form: phone number field", "Phone Number"),
