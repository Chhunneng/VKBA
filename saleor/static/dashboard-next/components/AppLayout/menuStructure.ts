...
import { ProductRequestUrl } from '../../productRequest/urls'
...
const menuStructure: IMenuItem[] = [
  {
    ariaLabel: "home",
    label: i18n.t("vkba-development1.0", { context: "Menu label" }),
    url: "/"
  },
  {
    ariaLabel: "catalogue",
  ...
  {
    ariaLabel: "Product Request",
    label: i18n.t("Product Request", { context: "Menu label" }),
