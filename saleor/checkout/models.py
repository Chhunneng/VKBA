...
class Checkout(models.Model):
    ...
    # <ADD
    # estimate_date_receive = models.DateTimeField(blank=True, null=True)
    # ADD>
    ...
    # <ADD
    def get_shipping_price_with_type_percentage(self, discounts, taxes):
        return (self.get_subtotal(discounts, taxes) * self.shipping_method.percentage / 100)
    def get_total_with_type_percentage(self, discounts, taxes):
        return (self.get_subtotal(discounts, taxes) + self.get_shipping_price_with_type_percentage(discounts,taxes) - self.discount_amount)
    # ADD>
